      ...
      <section className="relative min-h-[90vh] sm:min-h-[80vh] flex items-center justify-center pt-16 sm:pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          <div className="text-center space-y-8">
            ...
            <div className="flex items-center justify-center gap-2 text-gray-400 mt-4 mb-6">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span className="text-base sm:text-lg">Tiendesitas, Pasig City, Metro Manila, Philippines</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 border border-gray-800">
              <h3 className="text-2xl font-black mb-6">GET MATCHED WITH A COACH</h3>
              <div className="space-y-6">
                <div className="bg-white/5 rounded-xl p-6 border border-gray-800">
                  <h4 className="text-xl font-black mb-4">BOOK A COURT & COACH</h4>
                  <p className="text-gray-400 mb-4">
                    Ready to start? Book a court and schedule a session with your preferred coach through our online reservation system.
                  </p>
                  <a
                    href="https://picklehub-court-reservation.vercel.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full py-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl font-black tracking-wide text-center hover:scale-105 transition-transform shadow-lg shadow-orange-500/30"
                  >
                    RESERVE A COURT NOW
                  </a>
                </div>
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-gray-800">
                  ...
                  <p className="text-gray-400 mb-4">
                    Have questions? Reach out to us directly and we&apos;ll help match you with the perfect coach for your needs.
                  </p>
                  <div className="space-y-3">
                    ...
                    >
                      Email: coaches@pickleballhub.ph
                    </a>
                    <a
